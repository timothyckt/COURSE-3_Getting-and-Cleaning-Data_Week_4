...
trying URL 'https://cran.rstudio.com/bin/windows/contrib/3.3/data.table_1.10.0.zip'
Content type 'application/zip' length 1509158 bytes (1.4 MB)
downloaded 1.4 MB

package ‘data.table’ successfully unpacked and MD5 sums checked

The downloaded binary packages are in
	C:\Users\chanti\AppData\Local\Temp\RtmpspllxX\downloaded_packages
> install.packages("tidyr")
trying URL 'https://cran.rstudio.com/bin/windows/contrib/3.3/tidyr_0.6.0.zip'
Content type 'application/zip' length 854082 bytes (834 KB)
downloaded 834 KB
